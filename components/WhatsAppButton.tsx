...
export default async function WhatsAppButton() {
  ...
  return (
    <a
      href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(t("whatsappGenericPrefill"))}`}
      target="_blank"
      rel="noopener noreferrer"
      aria-label={t("whatsappAriaLabel")}
      className="fixed left-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform hover:scale-110 sm:left-5"
