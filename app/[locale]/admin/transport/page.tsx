...
export default async function AdminTransportPage() {
  ...
  return (
    <div>
      <h2 className="font-display text-2xl font-bold text-brand-navy">כל בקשות ההסעה</h2>
      ...
      {requests && requests.length > 0 ? (
        ...
        <EmptyState title="עדיין אין בקשות הסעה" className="mt-8" />
      )}
    </div>
  );
}
